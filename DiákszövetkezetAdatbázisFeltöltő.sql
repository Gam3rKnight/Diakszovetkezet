...
DELETE FROM Work;
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),1,'2018.03.15. 06:00:00', '2018.03.21. 14:00:00', 'Futószallagnál történõ munka. Betanítással együtt egy hét.', 'Operátori munka', 5); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),3,'2018.03.17. 08:00:00', '2018.03.19. 16:20:00', 'Sûrgõs adminisztrációs feladatok elvégzése.', 'Irodai munka', 2); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),4,'2018.03.20. 08:00:00', '2018.03.21. 16:20:00', 'Papírok rendezése, adminisztrálása', 'Irodai munka', 1);
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),5,'2018.05.30. 08:00:00', '2018.08.19. 16:20:00', 'Nyári munkára keresünk programozó hallgatókat', 'Programozó',1);  
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),6,'2018.03.17. 06:00:00', '2018.03.25. 14:00:00', 'Dobozok pakolása, cimkézése', 'Operátori munka', 3); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),2,'2018.04.30. 14:00:00', '2018.05.09. 22:00:00', 'Csomagoló gép kezelése.', 'Operátori munka', 2); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),7,'2018.04.10. 06:00:00', '2018.04.10. 14:00:00', 'Alkatrész válogatás, rendezés. Elektronikai végzetsség elõny!', 'Operátori munka', 1); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),1,'2018.03.15. 06:00:00', '2018.03.21. 14:00:00', 'Papírok rendezése, adminisztráció.', 'Irodai munka', 5); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),8,'2018.03.10. 06:00:00', '2018.03.21. 14:00:00', 'Angol nyelvismerettel rendelkezõt keresünk fordítási munkára.', 'Iroda munka', 1); 
INSERT INTO Work (w_id,company_id,w_datestart,w_dateend,w_description,w_name,s_number) VALUES((SELECT ISNULL(MAX(c_id)+1,0)FROM Companies WITH(SERIALIZABLE, UPDLOCK)),2,'2018.04.03. 06:00:00', '2018.04.21. 14:00:00', 'Raktározási munka', 'Operátori munka', 3); 